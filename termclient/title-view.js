...
module.exports = function TitleView() {
    ...
    views.remoteButton = button('joinRemoteButton', '{underline}J{/underline}oin Remote Game', 'j')
    views.localButton = button('startLocalButton', 'Start {underline}L{/underline}ocal Game', 'l')
    if (prefs.get('games')) {
        views.resumeButton = button('resumeGameButton', '{underline}R{/underline}esume Game', 'r')
    }
